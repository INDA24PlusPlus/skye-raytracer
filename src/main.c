...
cam->FOV=malloc(sizeof(float));
*(cam->FOV)=fov;
cam->AspectRatio=malloc(sizeof(float));
*(cam->AspectRatio)=ar;
cam->Pos=P;
cam->fScale=malloc(sizeof(float));
...
W->cObj=malloc(sizeof(int));
*(W->cObj)=2;
W->Objects=malloc(sizeof(Object*)*(*W->cObj+1));
W->Objects[0]=malloc(sizeof(Object));
// Sphere
W->Objects[0]->object.sph=malloc(sizeof(Sphere));
W->Objects[0]->object.sph->Midpoint=instanceiateVector(-2, 1, 5);
float* a=malloc(sizeof(float));
*a=2;	W->Objects[0]->object.sph->Radius=a;
W->Objects[0]->oType=OBJ_SPHERE;
W->Objects[0]->oMaterial=malloc(sizeof(Material));
a=malloc(sizeof(float));
*a=1;
W->Objects[0]->oMaterial->rgb=instanceiateVector(0.8, 0.7, 0.3);
W->Objects[0]->oMaterial->alpha=a;
W->Objects[1]=malloc(sizeof(Object));
// Ground
W->Objects[1]->object.pln=malloc(sizeof(Plane));
W->Objects[1]->object.pln->Normal=instanceiateVector(0, 1, 0);
a=malloc(sizeof(float));
*a=1;
W->Objects[1]->object.pln->Distance=a;
W->Objects[1]->oType=OBJ_PLANE;
W->Objects[1]->oMaterial=malloc(sizeof(Material));
a=malloc(sizeof(float));
*a=1;
W->Objects[1]->oMaterial->rgb=instanceiateVector(0.3, 0.8, 0.5);
W->Objects[1]->oMaterial->alpha=a;

W->Light=instanceiateVector(3, -7, 7);
...
{ 
	...
	for(int w=0; w<width*4;w++){
		for(int h=0; h<height*4;h++){
			float u=((float)w)/(4.0*(float)width);
			float v=((float)h)/(4.0*(float)height);
